...
$(function(){
    ...
    __GetIP();
    __GetInfo();
    console.log("%c🌳 Name：Tumadam | Bio：Sayy Hello | 🌳", "font-family: ;color:#fff; background: linear-gradient(270deg, #18d7d3, #68b7dd, #8695e6, #986fee); padding: 8px 15px; border-radius: 8px");
    console.log("…………./´¯/)……….. (\\¯’\\\n…………/….//……….. …\\\\….\\\n………../….//………… ….\\\\….\\\n…../´¯/…./´¯\\\\………../¯‘\\\\…./¯’\\\\\n.././…/…./…./.|_|……_| .\\\\…\\\\…\\\\…\\\\.\\\\\n(.(….(….(…./.)..)..(..(. \\\\….)….)….).)\n.\\\\…………….\\/…/…\\\\. ..\\/……………./\n..\\\\…………….. /……..\\\\………………../\n…\\\\…………..(………. ..)……………./");
  });
// CHECK FPS
...
// MUSIC PLAY
const MusicList=[
    "//files.catbox.moe/d7xy88.mp3",
    "//files.catbox.moe/p5tro5.mp3",
    "//files.catbox.moe/mdxcj8.mp3",
];
...
function ShowToast() {
  ...
  $(document).ready(function() {
    ...
    $('#Facebook').click(function() {
        OpenUrl('https://www.facebook.com/share/1J8mNKZDRm/?mibextid=wwXIfr');
    });
      // SET URL YOUTUBE
    $('#Youtube').click(function() {
        OpenUrl('https://youtube.com/@tumadamlengend?si=g-MbSBQ0gOkHxH4J');
    });
    // SET URL Tik Tok
    $('#Tik Tok').click(function() {
        OpenUrl('https://www.tiktok.com/@tumadam2507?_t=ZS-8y2ct7jBaXi&_r=1');
    });
      // SET URL Telegram
    $('#Telegram').click(function() {
        OpenUrl('https://t.me/tumadam2507');
    });
  });
